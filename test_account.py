...
class TestAccount(unittest.TestCase):
  def setUp(self):
    try:
      self.user1 = Account("Abbymercy1","Love23","abbymercy@gmail.com", 1, 2000)
        ...
        print("\nYou must edit the Account class to be instance variable: username, password, email, month, year")
        raise
  ...
  def test_username(self):
        self.assertRaises(ValueError, self.username, 111111)
        self.assertRaises(ValueError, self.username, 1.543 )
