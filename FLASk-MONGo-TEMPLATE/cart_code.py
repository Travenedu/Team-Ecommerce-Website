...
class Cart:
    ...
    def add_to_cart(self, item, quantity):
      """This method add items to the cart as they are being after being stocked up in inventory"""
    ...
    def remove_from_cart(self, item, quantity, current_quantity):
      """This method removes items from the cart as requested from the user"""
    ...
    def total_price(self):
      """This method calculates the total price of the item in the cart"""
      total = 0
